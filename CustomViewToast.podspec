#
# Be sure to run `pod lib lint CustomViewToast.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CustomViewToast'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CustomViewToast.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'CustomViewToast' => ['CustomViewToast/Assets/*.png']
  # }
